...
function customAssign(...objects) {
   ...
   if (typeof objects == "object" && objects.length >= 2) {
      let result = {};
      ...
      return result;
   } else return "Помилка: Має бути передано принаймні два об'єкти.";
}
...
function customObjectFromEntries(entries) {
   ...
   if (Array.isArray(entries)) {
      let list = entries.map(([key, value]) => {
...
function extendAndFreezeObject(obj1, obj2) {
   ...
   Object.freeze(obj1);
   return Object.isFrozen(obj1) ? obj1 : 'обєкт не було "заморожено"';
}
...
function sealAndCheck(obj) {
   ...
   Object.isSealed(obj) ? Object.isSealed(obj) : Object.seal(obj);
...
function getObjectValuesSum(obj) {
   ...
   return resultArr.reduce((sum, x) => (sum += x));
}
...
function convertArrayToObj(arr) {
   ...
   let res1 = Object.fromEntries(arr);
   //  console.log(res1);
   return res;
}
